...
class Lime():
    ...
    def __init__(self, img, n_class, n_superpixels = 50):
        """
        Inputs
        ...
        self.nu = 0.25 # AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
    ...
    def _cal_weight(self, activation_vector):
        ...
        d_cos = 1 - cos_sim
        weight = np.exp(- (d_cos ** 2) / (2 * self.nu ** 2))
        return weight
